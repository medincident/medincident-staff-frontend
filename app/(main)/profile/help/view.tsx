...
const FAQ_DB: FaqItem[] = [
  {
    question: "Как создать техническую заявку?",
    answer: "Перейдите в раздел «Заявки» и нажмите кнопку «Новая заявка». Укажите тип проблемы, опишите её, добавьте фотографии (если есть) и выберите приоритет. Заявка будет направлена в профильную службу."
  },
  {
    question: "Кто видит зарегистрированные инциденты?",
    answer: "Инциденты видят только сотрудники, участвующие в процессе расследования, а также руководство и служба качества. Рядовые сотрудники видят только свои заявки."
  },
  {
    question: "Как отвязать заявку от инцидента?",
    answer: "В карточке инцидента перейдите к списку связанных заявок и нажмите иконку отвязки (разрыв цепи) напротив нужной заявки. Эта функция доступна только ответственным за инцидент."
  },
  {
    question: "Где посмотреть статистику по своему отделению?",
    answer: "В разделе «Отчёты» выберите фильтр по своему отделению. Вам будут доступны графики по типам заявок и количеству нежелательных событий."
  }
];
