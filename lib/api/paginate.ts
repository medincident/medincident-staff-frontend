// Универсальный pager для эндпоинтов бэка с пагинацией.
//
// Контракт ответа везде одинаковый: `{ items?: T[]; nextCursor?: string }`.
// Параметр курсора в сервисах называется `after` и идёт последним
// в сигнатуре. Этот хелпер собирает все страницы и возвращает плоский массив.
//
// На случай битого бэка или цикла поставлен предохранитель `maxPages`.
